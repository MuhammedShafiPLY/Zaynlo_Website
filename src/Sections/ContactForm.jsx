        ...
        >
          ...
          <form className="space-y-6">
            ...
            <motion.button 
              ...
              whileTap={{ scale: 0.98 }}
              type="button" 
              className="w-full bg-white text-black font-black uppercase tracking-widest py-4 rounded-xl hover:bg-[#dbe11d] transition-colors duration-300 shadow-[0_0_20px_rgba(255,255,255,0.1)] hover:shadow-[0_0_30px_rgba(219,225,29,0.4)]"
            >
              Send Message
            </motion.button>
          </form>
